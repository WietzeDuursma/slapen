			...
			<ul class="slides">
				...
				while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
					...
					if ( get_post_meta( get_the_id(), 'ctslider_slidelink', true ) != '' ) { ?>
						<span class="hide-on-phones"><a href="<?php echo esc_url( get_post_meta( get_the_id(), 'ctslider_slidelink', true ) ); ?>"></span>
					<?php
					}
					...
					if ( get_post_meta( get_the_id(), 'ctslider_slidelink', true ) != '' ) { ?>
						<span class="hide-on-phones"></a></span>
					<?php } ?>
                    ...
                    <p class="flex-caption hide-on-phones"><span class="opa"><strong style="color:#FFF;font-size:14px;opacity:1.0;filter:alpha(opacity=100);"><?php the_title(); ?></strong><br /><?php echo get_post_meta( get_the_id(), 'ctslider_captiontext', true ); ?></span></p>
					<?php } ?>
