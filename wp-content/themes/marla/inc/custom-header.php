...
?>
		...
		<?php if ( ! empty( $header_image ) ) : ?>
			<?php if (!is_home() ) { ?><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"><?php } ?><img class="logo"  src="<?php echo esc_url( $header_image ); ?>"  alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" /><?php if (!is_home() ) { ?></a><?php } ?>
		<?php endif; ?>
